  ...
  return (
    <div className="w-[605px] border bg-neutral-100 p-10 rounded-[20px] border-solid border-[#524f4f] max-md:w-full max-sm:p-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-40 h-[54px] text-white text-xl font-bold cursor-pointer bg-[#fe623f] block mx-auto my-5 rounded-[20px] border-[none] hover:bg-[#e55636] transition-colors"
        >
          LOG IN
        </button>
      </form>
      ...
      <div className="text-center text-base italic mt-5">
        ...
        <span className="underline cursor-pointer hover:text-[#fe623f] transition-colors">
          Register Here
        </span>
      </div>

...
const mockAssignedEstablishments = [
  {
    id: "1",
    name: "James Shop",
    dti: "111111111",
...
const InspectorMap = () => {
  ...
  useEffect(() => {
    toast.info("Map Component", {
      description: "Leaflet/OpenStreetMap would be integrated here to display assigned establishments."
    });
  }, []);
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            View your assigned establishments on the map.
          </p>
        </div>
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Map integration with Leaflet/OpenStreetMap would display your assigned establishments with color-coded markers:
                </p>
        ...
        {/* Establishment List */}
        <div className="mt-6">
          <h2 className="text-lg font-medium mb-4">Assigned Establishments</h2>
          
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {mockAssignedEstablishments.map((establishment) => (
              <Card key={establishment.id} className="overflow-hidden">
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-xs font-medium">
                      {new Date(establishment.date).toLocaleString(undefined, {
                        month: 'short',
                        day: 'numeric',
                        hour: '2-digit',
                        minute: '2-digit'
                    ...
                    <div className="text-xs px-2 py-1 rounded" 
                      style={{
                        backgroundColor: establishment.status === 'Scheduled' ? '#DBEAFE' : '#D1FAE5',
                        color: establishment.status === 'Scheduled' ? '#1E40AF' : '#065F46'
                      }}>
                ...
                <div className="border-t px-4 py-2 bg-gray-50 flex justify-end">
                  <Button size="sm" className="text-xs bg-vfire-orange hover:bg-vfire-orange-600">
                    {establishment.status === 'Scheduled' ? 'Conduct Inspection' : 'View Details'}
                  </Button>
                </div>
              </Card>
            ))}

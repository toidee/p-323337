...
const InspectorNotifications = () => {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<"all" | "unread" | "read">("all");
  
  // Filter notifications for this inspector
  const notifications = mockNotifications.filter(
    n => n.role === "inspector" && (user ? n.user_id === user.id : true)
  );
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Stay updated with your inspection activities and system alerts.
          </p>
        </div>
...
export default InspectorNotifications;

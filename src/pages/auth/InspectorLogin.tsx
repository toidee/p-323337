...
const InspectorLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await login(email, password, "inspector");
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Inspector Login</h2>
          <p className="text-gray-500">Sign in to manage inspections</p>
        </div>
